 ...
 * The account is locked for the period of a withdraw.
 * @author BagyuraI
 */
public class BankingExampleWithSynch
{
	...
	private static class Account
	{
		 ...
		 */
		public synchronized boolean deduct( float amount, long sleepMillis)
		{
			...
			if ( amount <= total )
			{
				...
				BankingExampleWithSynch.sleep( sleepMillis );
				total -= amount;
				System.out.println( thread + " deducted " + amount  );
				return true;
			}
			System.out.println( thread + " couldn't deduct " +amount + ", balance is " + total  );
			return false;
		}
