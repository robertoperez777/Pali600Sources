...
privileged aspect ChurchMaintenance_Roo_Jpa_ActiveRecord {
    ...
    public static final List<String> ChurchMaintenance.fieldNames4OrderClauseFilter = java.util.Arrays.asList("yearOfMaintenance", "paymentNumber", "amount", "description");
    ...
    public static List<ChurchMaintenance> ChurchMaintenance.findAllChurchMaintenances(String sortFieldName, String sortOrder) {
        String jpaQuery = "SELECT o FROM ChurchMaintenance o";
        ...
        return entityManager().createQuery(jpaQuery, ChurchMaintenance.class).getResultList();
    }
    ...
    public static List<ChurchMaintenance> ChurchMaintenance.findChurchMaintenanceEntries(int firstResult, int maxResults, String sortFieldName, String sortOrder) {
        String jpaQuery = "SELECT o FROM ChurchMaintenance o";
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
            jpaQuery = jpaQuery + " ORDER BY " + sortFieldName;
            if ("ASC".equalsIgnoreCase(sortOrder) || "DESC".equalsIgnoreCase(sortOrder)) {
        ...
        return entityManager().createQuery(jpaQuery, ChurchMaintenance.class).setFirstResult(firstResult).setMaxResults(maxResults).getResultList();
    }
