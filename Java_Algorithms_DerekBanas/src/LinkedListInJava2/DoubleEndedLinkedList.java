...
public class DoubleEndedLinkedList {
	...
	public void insertInFirstPosition(String homeOwnerName, int houseNumber) {
		...
		if (this.isEmpty()) {
			...
			this.lastLink = theNewLink;

		} /* FOR DOUBLY LINKED LIST */else {

			this.firstLink.previous = theNewLink;
		...
		theNewLink.next = this.firstLink;

		this.firstLink = theNewLink;
	...
	public void insertInLastPosition(String homeOwnerName, int houseNumber) {
		...
		if (this.isEmpty()) {
			...
			this.lastLink.next = theNewLink;

			theNewLink.previous = this.lastLink; // FOR DOUBLY LINKED LIST
	...
	public boolean insertAfterKey(String homeOwnerName, int houseNumber, int key) {
		...
		Neighbor currentNeighbor = this.firstLink; // Starts search at first link
		...
		if (currentNeighbor == this.lastLink) {
	...
	public void insertInOrder(String homeOwnerName, int houseNumber) {
		...
		Neighbor currentNeighbor = this.firstLink;
	...
	public void display() {
		...
		Neighbor theLink = this.firstLink;
...
class Neighbor {
	...
	public void display() {
		...
		System.out.println(this.homeOwnerName + ": " + this.houseNumber + " Privet Drive");
...
class NeighborIterator {
	...
	public boolean hasNext() {
		...
		if (this.currentNeighbor.next != null) {
	...
	public Neighbor next() {
		...
		if (this.hasNext()) {
			...
			this.previousNeighbor = this.currentNeighbor;
			this.currentNeighbor = this.currentNeighbor.next;
	...
	public void remove() {
		...
		if (this.previousNeighbor == null) {
			...
			this.theNeighbors.firstLink = this.currentNeighbor.next;

		} else {

			this.previousNeighbor.next = this.currentNeighbor.next;
			...
			if (this.currentNeighbor.next == null) {
				...
				this.currentNeighbor = this.theNeighbors.firstLink;
