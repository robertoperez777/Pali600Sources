...
public class Recursion {
	...
	public int getTriangularNumR(int number) {
		...
		if (number == 1) {
			...
			int result = number + this.getTriangularNumR(number - 1);
	...
	public int getFactorial(int number) {
		...
		if (number == 1) {
			...
			int result = number * this.getFactorial(number - 1);
	...
	public void calculateSquaresToPrint(int number) {
		...
		for (int i = 1; i <= number; i++) {
			...
			System.out.println("Triangular Number: " + this.calcTriangularNum(i));
