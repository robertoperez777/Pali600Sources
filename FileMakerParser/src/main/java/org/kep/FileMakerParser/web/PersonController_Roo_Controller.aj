...
import org.kep.FileMakerParser.web.PersonController;
...
privileged aspect PersonController_Roo_Controller {
    ...
    @Autowired
    AddressService PersonController.addressService;
    
    @Autowired
    ChurchMaintenanceService PersonController.churchMaintenanceService;
    
    @Autowired
    MunificenceService PersonController.munificenceService;
    
    @Autowired
    PhoneNumberService PersonController.phoneNumberService;
